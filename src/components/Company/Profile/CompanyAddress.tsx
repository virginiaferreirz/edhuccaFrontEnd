...
export const CompanyAddress = () => {
  const { register, handleSubmit } = useForm<ProfileAddressForm>();
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="px-72 items-center justify-center h-screen">
            <div className="bg-white p-12 pb-4 border rounded-md shadow-md">
              ...
              <label
                htmlFor="bairro"
                className="block text-sm font-medium text-gray-600 pt-2 bg-white"
              >
                Bairro
              </label>
              <input
              ...
              <label
                htmlFor="city"
                className="block text-sm font-medium text-gray-600 bg-white pt-2"
              >
                Cidade
              </label>
              <input
