      ...
      <div className="bg-gray-100 h-screen flex items-center justify-center">
        <div className="text-center pl-24 pr-8">
          <h1 className="text-4xl font-bold mb-8">
            Portal Oportunidade - Estágios
          </h1>
          <p className="text-gray-600">
            O Portal Oportunidade do EDHUCCA é uma plataforma de vagas de
            emprego, um ecosistema que une estudantes capacitados a
            oportunidades enriquecedoras de estágio na cidade de Apucarana-PR e
            região. Nossa missão é impulsionar o crescimento profissional de
